  ...
  return (
    <main className="max-w-[1440px] mx-auto min-h-screen px-6 pb-24">
      <div className="flex justify-center w-full">
        <div className="flex flex-col gap-4 w-full max-w-3xl pt-[clamp(6rem,15vw,14rem)]">
          <h1 className="font-body font-medium">
            <DiaTextReveal text={["Alfarhaankhan Inamdar"]} />
          </h1>
          <p className="font-body-sm font-light">
            <DiaTextReveal textColor="var(--body)" lineHeightGap="1">
              <>
                ...
                . Currently learning{" "}
                <span className="italic font-normal">Japanese</span> and
                exploring low-level systems and developer tooling. Open to
                creative <span className="font-normal">frontend</span> and{" "}
          ...
          <div>
            ...
            <p className="text-center w-full font-light text-[12px] whitespace-normal sm:whitespace-nowrap mt-4">
              <DiaTextReveal textColor="var(--subtext)" delay={2}>
                <>
                  Heart of the Forest —{" "}
