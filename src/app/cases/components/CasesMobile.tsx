...
const CasesMobile = () => {
  ...
  return (
    <div className="min-h-screen bg-[#D6D2CD] px-6 pt-32 pb-12 flex flex-col relative overflow-hidden">
      {/* Title Group */}
      <div className="mb-8">
        <h1 className="text-[#963531] text-[18px] font-bold mb-4">{t.title}</h1>
        <p className="text-[#963531] text-[15px] leading-snug w-[90%]">
          {t.description}
        </p>
      </div>
          ...
          <button
            ...
            className={`text-[14px] text-left transition-colors duration-300 ${
              activeFilter === filter
                ...
                : "text-[#963531]/40 hover:text-[#963531]/70"
            }`}
          >
            {filter}
          </button>
      ...
      {activeProject && (
        <div className="absolute bottom-12 left-6 right-6 h-16">
          <div className="relative w-full h-full" ref={minimapRef}>
            ...
            <div className="absolute top-0 left-0 w-16 h-16 border border-[#963531] z-20 pointer-events-none bg-transparent"></div>
