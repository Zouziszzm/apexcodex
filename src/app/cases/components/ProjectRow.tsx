      ...
      <div className={`w-full py-2 md:py-4`}>
        <div className="w-full mx-auto">
          ...
          >
            <button
              onClick={onClose}
              className="flex items-center gap-2 text-[16px] text-[var(--text-primary)] hover:opacity-70 transition-all duration-700 uppercase tracking-wider font-medium pointer-events-auto"
            >
          ...
          >
            <p className="text-[var(--text-primary)] text-[20px] mb-2 md:mb-0 group-hover:translate-x-2 transition-all duration-700">
              {project.title}
            </p>
            <div className="w-full md:w-[45%] flex justify-between items-center">
              ...
              <p className="text-[var(--text-primary)] text-[18px] transition-colors duration-700">
                {project.category}
              </p>
            </div>
          </div>
