      ...
      <div className="mt-3 overflow-hidden">
        ...
        >
          {value.split(", ").map((tech, i) => (
            ...
            >
              <div
                className={`text-[14px] lg:text-[14px] w-full h-full py-1 text-[var(--text-primary)] transition-all duration-300 cursor-default flex items-center justify-start text-left px-1 ${
